...
import { Phone, Mail, MapPin, MessageCircle, Clock, Send, Instagram } from 'lucide-react';
  ...
  const contactInfo = [
    {
      ...
      title: 'Call Us',
      details: [
        { label: 'Naveen', value: '+91 6301241568', href: 'tel:+916301241568' },
        { label: 'Parvez', value: '+91 6305009371', href: 'tel:+916305009371' },
      ],
    },
    {
      icon: MapPin,
    ...
    },
    {
      ...
      title: 'Working Hours',
      details: [
        { label: 'Mon - Sat', value: '9:00 AM - 7:00 PM', href: null },
        { label: 'Sunday', value: 'By Appointment', href: null },
      ],
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Have questions about materials, construction, or properties? 
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger data-testid="contact-service" className="mt-1">
                  ...
                  <Button 
                    ...
                    className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold uppercase tracking-wider rounded-full py-6"
                  >
            ...
            <div className="space-y-6">
                ...
                <Card key={index} className="border-none shadow-md">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-heading text-xl font-bold text-[#001F3F]">{info.title}</h3>
                          ...
                          {info.details.map((detail, idx) => (
                            <div key={idx}>
                              ...
                              {detail.href ? (
                                <a 
                                  href={detail.href}
                                  className="block text-[#001F3F] font-medium hover:text-[#FFD700] transition-colors"
                                >
                                  {detail.value}
                                </a>
                              ) : (
                                <p className="text-[#001F3F] font-medium">{detail.value}</p>
                              )}
                            </div>
                          ))}
                        </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-4">
                    <a 
                      ...
                      data-testid="instagram-link-infra"
                      className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg hover:bg-[#FFD700] hover:text-[#001F3F] text-white transition-all"
                    >
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      data-testid="instagram-link-properties"
                      className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg hover:bg-[#FFD700] hover:text-[#001F3F] text-white transition-all"
                    >
                      <Instagram className="w-5 h-5" />
                      <span>@lmn.properties</span>
                    </a>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-[#25D366] shadow-md">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mt-2 mb-4">Get instant response on WhatsApp</p>
                  <a 
                    href="https://wa.me/916301241568?text=Hi!%20I%20want%20to%20know%20more%20about%20LMN%20Infra%20services."
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button 
                      data-testid="quick-whatsapp-btn"
                      className="bg-[#25D366] hover:bg-[#128C7E] text-white font-bold rounded-full px-8"
                    >
                      <MessageCircle className="w-5 h-5 mr-2" />
                      Chat Now
                    </Button>
